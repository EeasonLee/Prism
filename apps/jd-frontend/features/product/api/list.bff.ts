import type { ProductListResult } from '../bff-types';
import { searchProductsForBFF } from './meilisearch.bff';

export type { ProductCardItem, ProductListResult } from '../bff-types';
