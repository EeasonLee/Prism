...
export default function AccountProfilePage() {
  ...
  const { user, isLoading, error, updateProfile, changePassword, deleteAccount, logout } = useAccount({
    loadUser: true,
    loadOrders: false,
    loadAddresses: false,
  });
  ...
  return (
    ...
    >
      ...
      <div className="mt-8 border-t border-border pt-6">
        <h3 className="mb-3 text-base font-semibold text-red-600">Danger zone</h3>
        <button
          type="button"
      ...
      {showDeleteConfirm && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 px-4">
          <div className="w-full max-w-md rounded-xl bg-background p-6 shadow-xl">
            <h4 className="mb-2 text-lg font-semibold text-ink">Delete your account?</h4>
            <p className="mb-4 text-sm text-ink-muted">
              This action cannot be undone. All your data including orders and addresses will be permanently removed.
            </p>
