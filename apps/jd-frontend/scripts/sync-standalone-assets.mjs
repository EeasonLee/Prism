/**
 * standalone 产物默认不含浏览器端 .next/static 与 public，需复制进 standalone 应用目录，
 * 否则线上 /_next/static/chunks/* 会 404。
...
const standaloneAppDir = join(standaloneRoot, 'apps', 'jd-frontend');
