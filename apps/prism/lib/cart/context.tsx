...
export function CartProvider({ children }: { children: React.ReactNode }) {
  ...
  useEffect(() => {
    ...
    const initialized = prev.hasSession !== null && prev.isAuthenticated !== null;

    const sessionBecameAvailable = initialized && !prev.hasSession && hasSession;
    const justLoggedIn =
      initialized &&
    ...
    const justLoggedOut = initialized && prev.isAuthenticated && !isAuthenticated;
