...
import type { HeroBannerProps } from '@/lib/api/cms-page.types';
          ...
          <div className="relative z-20 flex h-full items-center">
            <div className="w-full px-6 lg:px-[8vw]">
              <div className="max-w-xl">
                ...
                <p
                  className={`mb-8 text-lg transition-all duration-700 delay-150 lg:text-xl ${
                    index === currentSlide
                      ? 'translate-y-0 opacity-100'
                      : 'translate-y-8 opacity-0'
                  } ${
                    slide.theme === 'dark' ? 'text-ink-muted' : 'text-white/90'
                  }`}
                >
                  {slide.subtitle}
                </p>
