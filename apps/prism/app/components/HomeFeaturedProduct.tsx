...
export function HomeFeaturedProduct() {
  ...
  return (
    <section
      ref={sectionRef}
      className="relative w-full overflow-hidden bg-[#F6F6F2] py-16 lg:py-32"
    >
      <div className="w-full px-5 sm:px-6 lg:px-[8vw]">
        <div className="flex flex-col gap-10 lg:flex-row lg:items-center lg:gap-16">
          <div ref={contentRef} className="order-2 lg:order-1 lg:w-1/2">
            ...
            >
              Joydeem Soy
              <br className="hidden sm:block" /> Milk Maker
            </h2>
            <p className="mb-6 text-base leading-relaxed text-[#6B6B6B] lg:mb-8 lg:text-lg">
              Experience the perfect morning ritual with our bestselling soy
              milk maker. Fresh, smooth, and nutritious soy milk in just
              minutes. Designed for modern lifestyles.
            </p>
          ...
          <div ref={imageRef} className="order-1 lg:order-2 lg:w-1/2">
            <div className="relative mx-auto max-w-sm lg:max-w-none">
              <div className="aspect-square overflow-hidden rounded-[20px] bg-white card-shadow lg:rounded-[28px]">
                <Image
                  src="/images/product_soymilk_card.jpg"
                  alt="Joydeem Soy Milk Maker"
                  width={480}
                  height={480}
                  className="h-full w-full object-contain p-6 lg:p-8"
                />
              </div>
              <div className="absolute -right-3 -top-3 flex h-16 w-16 items-center justify-center rounded-full bg-[#D94F25] text-center text-xs font-bold text-white shadow-lg lg:-right-4 lg:-top-4 lg:h-20 lg:w-20 lg:text-sm">
                Best
                <br />
                Seller
              </div>
